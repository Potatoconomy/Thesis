...
##~ User Paths ~################################
################################################
df_dir  <- '/home/patrick/Desktop/Figures_Human_GBM/Ctrl_Comparison/'
path_dir <- '/home/patrick/Desktop/Figures_Human_GBM/Ctrl_Comparison/'
fig_save_path <- '/home/patrick/Desktop/Figures_Human_GBM/Ctrl_Comparison/LeadingEdge/'
...
interesting_pathways <- function(FGSEA) {
  ...
  somepaths <- c('BP.GO_REGULATION_OF_INTRINSIC_APOPTOTIC_SIGNALING_PATHWAY',
                 'BP.GO_RESPONSE_TO_REACTIVE_OXYGEN_SPECIES',
                 'BP.GO_AGING')
